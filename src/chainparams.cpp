...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.coinb.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("coinbtools.com", "dnsseed.coinbtools.com"));
        vSeeds.push_back(CDNSSeedData("coinbpool.org", "dnsseed.coinbpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("coinbtools.com", "testnet-seed.coinbtools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.coinb.loshan.co.uk", true));
