...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s coinb-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  coinb-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coinb transaction") + "\n" +
              "  coinb-tx [options] -create [commands]   " + _("Create hex-encoded coinb transaction") + "\n" +
              "\n";
